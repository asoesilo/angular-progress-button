angular.module('progressButton', [])
	.directive('progressButton', function($timeout) {
		return {
			...
			template: '<button class="progress-button"><span class="progress-button-text" ng-transclude></span><span class="progress-button-bar progress-button-{{type}}"></span></button>',
